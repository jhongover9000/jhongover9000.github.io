// Assignment 4: 221A Jump Street. (JS - Game Script)
// Description: This is the JS script for the video content of the website.
// ===================================================================================================
// ===================================================================================================
// Initialization
...
for(var i = 0; i < 4; i++){
    var temp = new WrongLocation("wrong/wrong"+String(i*10+0)+".mp4","wrong/wrong"+String(i*10+1)+".mp4",
    "wrong/wrong"+String(i*10+2)+".mp4","wrong/wrong"+String(i*10+3)+".mp4","wrong/wrong"+String(i*10+4)+".mp4");
    if(i == 0){
...
for(var i = 0; i < 4; i++){
    var temp = new RightLocation("right/right"+String(i*10+0)+".mp4","right/right"+String(i*10+1)+".mp4",
    "right/right"+String(i*10+2)+".mp4");
...
for(var i = 0; i < 4; i++){
    var temp = new IntroScene("intro/intro"+String(i*10+0)+".mp4","intro/intro"+String(i*10+1)+".mp4",
    "intro/intro"+String(i*10+2)+".mp4","intro/intro"+String(i*10+3)+".mp4");
...
// Load End Scenes.
for(var i = 0; i < 3; i++){
    var temp = new Ending("ending/ending"+i+".mp4");
